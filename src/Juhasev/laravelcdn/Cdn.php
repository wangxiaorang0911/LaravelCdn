...
use Juhasev\laravelcdn\Contracts\AssetInterface;
use Juhasev\laravelcdn\Contracts\CdnHelperInterface;
use Juhasev\laravelcdn\Contracts\CdnInterface;
use Juhasev\laravelcdn\Contracts\FinderInterface;
...
class Cdn implements CdnInterface
{
     ...
     *
     * @internal param \Juhasev\laravelcdn\Repository $configurations
     */
    ...
    /**
     * Will be called from the Juhasev\laravelcdn\PushCommand class on Fire().
     */
    ...
    /**
     * Will be called from the Juhasev\laravelcdn\EmptyCommand class on Fire().
     */
