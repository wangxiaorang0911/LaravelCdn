...
use Juhasev\laravelcdn\Contracts\CdnFacadeInterface;
use Juhasev\laravelcdn\Contracts\CdnHelperInterface;
use Juhasev\laravelcdn\Contracts\ProviderFactoryInterface;
use Juhasev\laravelcdn\Exceptions\EmptyPathException;
use Juhasev\laravelcdn\Validators\CdnFacadeValidator;
...
class CdnFacade implements CdnFacadeInterface
{
    ...
    /**
     * @var \Juhasev\laravelcdn\Contracts\ProviderFactoryInterface
     */
     ...
     *
     * @var \Juhasev\laravelcdn\Providers\Contracts\ProviderInterface
     */
    protected $provider;

    /**
     * @var \Juhasev\laravelcdn\Contracts\CdnHelperInterface
     */
    protected $helper;

    /**
     * @var \Juhasev\laravelcdn\Validators\CdnFacadeValidator
     */
     ...
     *
     * @param \Juhasev\laravelcdn\Contracts\ProviderFactoryInterface $provider_factory
     * @param \Juhasev\laravelcdn\Contracts\CdnHelperInterface       $helper
     * @param \Juhasev\laravelcdn\Validators\CdnFacadeValidator      $cdn_facade_validator
     */
